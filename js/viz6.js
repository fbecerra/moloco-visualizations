...
if (urlPath6.includes('/ja/')) {
    ...
    drawViz6(
        ...
        groupInfo = {
            ...
            'East Asia Pacific': "동아시아 태평양 시장은 대부분의 장르에서 평균 유저 가치가 가장 높습니다. 그러나 현지화와 문화적 차이로 인해 비현지 마케터들에게 진입 장벽이 높을 수 있습니다. 이 지역에서는 미드코어 장르(RPG, 전략, 시뮬레이션)가 유저 가치와 총 IAP 매출에서 상대적으로 강세를 보입니다<br>또, 한국은 전 세계에서 가장 높은 가치의 유저들을 보유한 시장 중 하나로, 유저당 평균 매출(ARPPU)이 22달러로 글로벌 평균인 11달러를 크게 상회합니다. 또, 다른 시장에 비해 적정 수준의 UA 비용과 높은 평균 가치를 기반으로 UA 관점에서 수익성과 성장 가능성이 높은, 매력적인 시장으로 자리 잡고 있습니다.",
