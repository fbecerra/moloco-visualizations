...
if (urlPath8.includes('/ja/')) {
    ...
    drawViz8(
        ...
        columnLabels = [
            ...
            `IAP 매출 <div id="cpp-tooltip" class="column-tooltip" style="vertical-align: text-top;">${moreInfoIcon}<span class="column-tooltip-text">시장에 기여한 총 매출 (오가닉 및 페이드)</span></div>`
        ],
        groups = [
            '미국 및 영어권 시장',
            '동아시아 태평양',
    ...
    drawViz8(
        ...
        columnLabels = [
            ...
            `IAP revenue <div id="cpp-tooltip" class="column-tooltip" style="vertical-align: text-top;">${moreInfoIcon}<span class="column-tooltip-text">市场带来的总收益贡献（包括付费流量和自然流量）</span></div>`
        ],
        groups = [
